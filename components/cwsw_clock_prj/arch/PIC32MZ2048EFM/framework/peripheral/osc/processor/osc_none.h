...
#include "osc_PBClockDivisor_none.h"		/* <<== klb: changed path portion & variant suffix of statement */
...
#include "osc_PLLMultiplier_none.h"
...
#include "osc_FRCDivisor_Default.h"			// <<== comment / remove
...
#include "osc_OscSelect_none.h"				// <<== comment / remove
static PLIB_INLINE void
...
#include "osc_PLLClockLock_Default.h"		// <<== comment / remove
...
#include "osc_PLLOutputDivisor_none.h"		// <<== comment / remove
static PLIB_INLINE void
