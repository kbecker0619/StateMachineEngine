 ...
 *	@tableofcontents
 *	To add the facilities of the CWSW Lib component to your project, follow these steps. Note these
 *	steps are for Eclipse and derivatives (e.g., NXP S32DS).
