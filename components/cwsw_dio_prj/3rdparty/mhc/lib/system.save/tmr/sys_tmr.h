...
#include "sys_clk.h"
#include "../../../../../cwsw_arch/pic32mz/framework/system/common/sys_module.h"					/* klb: SYS_MODULE_INIT */
...
extern SYS_TMR_HANDLE SYS_TMR_CallbackPeriodic ( uint32_t periodMs, uintptr_t context, SYS_TMR_CALLBACK   callback );
