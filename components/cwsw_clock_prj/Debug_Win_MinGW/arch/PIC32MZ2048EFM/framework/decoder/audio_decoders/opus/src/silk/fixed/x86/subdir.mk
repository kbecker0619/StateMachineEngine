...
C_SRCS += \
../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/burg_modified_FIX_sse.c \
../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/prefilter_FIX_sse.c \
../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/vector_ops_FIX_sse.c 

OBJS += \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/burg_modified_FIX_sse.o \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/prefilter_FIX_sse.o \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/vector_ops_FIX_sse.o 

C_DEPS += \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/burg_modified_FIX_sse.d \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/prefilter_FIX_sse.d \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/vector_ops_FIX_sse.d 


# Each subdirectory must supply rules for building sources it contributes
arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/%.o: ../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/opus/src/silk/fixed/x86/%.c
	@echo 'Building file: $<'
