...
C_SRCS += \
../cwsw_arch/i386/system/ports/src/sys_ports_static.c 

OBJS += \
./cwsw_arch/i386/system/ports/src/sys_ports_static.o 

C_DEPS += \
./cwsw_arch/i386/system/ports/src/sys_ports_static.d 


# Each subdirectory must supply rules for building sources it contributes
cwsw_arch/i386/system/ports/src/%.o: ../cwsw_arch/i386/system/ports/src/%.c
	@echo 'Building file: $<'
