...
#define APP_LED_PORT        PORT_CHANNEL_H  // LEDs connected to PIC32 I/O PortH
#define APP_LED1_PIN        PORTS_BIT_POS_0 // Pin RH0
#define APP_LED2_PIN        PORTS_BIT_POS_1 // Pin RH1
#define APP_LED3_PIN        PORTS_BIT_POS_2 // Pin RH2
