...
C_SRCS += \
../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/utils/utils.c 

OBJS += \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/utils/utils.o 

C_DEPS += \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/utils/utils.d 


# Each subdirectory must supply rules for building sources it contributes
arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/utils/%.o: ../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/utils/%.c
	@echo 'Building file: $<'
