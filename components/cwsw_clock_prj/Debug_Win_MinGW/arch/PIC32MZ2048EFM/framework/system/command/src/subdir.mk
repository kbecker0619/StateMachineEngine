...
C_SRCS += \
../arch/PIC32MZ2048EFM/framework/system/command/src/sys_command.c 

OBJS += \
./arch/PIC32MZ2048EFM/framework/system/command/src/sys_command.o 

C_DEPS += \
./arch/PIC32MZ2048EFM/framework/system/command/src/sys_command.d 


# Each subdirectory must supply rules for building sources it contributes
arch/PIC32MZ2048EFM/framework/system/command/src/%.o: ../arch/PIC32MZ2048EFM/framework/system/command/src/%.c
	@echo 'Building file: $<'
