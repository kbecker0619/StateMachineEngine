...
C_SRCS += \
../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/adpcm/adpcm_dec.c 

OBJS += \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/adpcm/adpcm_dec.o 

C_DEPS += \
./arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/adpcm/adpcm_dec.d 


# Each subdirectory must supply rules for building sources it contributes
arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/adpcm/%.o: ../arch/PIC32MZ2048EFM/framework/decoder/audio_decoders/adpcm/%.c
	@echo 'Building file: $<'
