...
//#include "osc_FRCDivisor_Default.h"		// <<== uncomment here
//#include "osc_OscSelect_none.h"				/* <<== klb: changed path portion & variant suffix of statement */
...
#include "osc/osc_PBClockDivisor_none.h"		/* <<== klb: changed path portion & variant suffix of statement */
...
//#include "osc_PLLClockLock_Default.h"		// <<== uncomment here
#include "osc/osc_PLLMultiplier_none.h"
...
//#include "osc_PLLOutputDivisor_none.h"	// <<== uncomment here
...
#include "osc/osc_FRCDivisor_Default.h"			// <<== comment / remove
static PLIB_INLINE void
PLIB_OSC_FRCDivisorSelect(OSC_MODULE_ID index, OSC_FRC_DIV divisorFRC)
{
	UNUSED(index);
	UNUSED(divisorFRC);
...
#include "osc/osc_OscSelect_none.h"				// <<== comment / remove
static PLIB_INLINE void
PLIB_OSC_SysClockSelect(OSC_MODULE_ID index, OSC_SYS_TYPE newOsc)
{
	UNUSED(index);
	UNUSED(newOsc);
...
static PLIB_INLINE OSC_SYS_TYPE
PLIB_OSC_CurrentSysClockGet(OSC_MODULE_ID index)
{
	/* klb: for now, bypass the specific-MCU function and return a generic value */
	UNUSED(index);
...
#include "osc/osc_PLLClockLock_Default.h"		// <<== comment / remove
static PLIB_INLINE bool
PLIB_OSC_PLLClockIsLocked(OSC_MODULE_ID index)
{
#if 0
...
static PLIB_INLINE void
PLIB_OSC_SysPLLMultiplierSelect(OSC_MODULE_ID index, OSC_SYSPLL_MULTIPLIER_TYPE pll_multiplier)
{
...
#include "osc/osc_PLLOutputDivisor_none.h"		// <<== comment / remove
static PLIB_INLINE void
PLIB_OSC_SysPLLOutputDivisorSet(OSC_MODULE_ID index, OSC_SYSPLL_OUT_DIV PLLOutDiv)
{
	UNUSED(index);
	UNUSED(PLLOutDiv);
...
static PLIB_INLINE uint16_t
PLIB_OSC_SysPLLInputDivisorGet(OSC_MODULE_ID index)
{
	/* klb: for now, bypass the specific-MCU function and return a generic value */
	UNUSED(index);
	return 1;
...
static PLIB_INLINE OSC_SYSPLL_IN_CLK_SOURCE
PLIB_OSC_SysPLLInputClockSourceGet(OSC_MODULE_ID index)
{
	/* klb: for now, bypass the specific-MCU function and return a generic value */
	UNUSED(index);
	return OSC_SYSPLL_IN_CLK_SOURCE_PRIMARY;
}
